# Apache Tomcat9 Config

[![Java CI](https://github.com/hazendaz/tomcat9-config/actions/workflows/ci.yaml/badge.svg)](https://github.com/hazendaz/tomcat9-config/actions/workflows/ci.yaml)
[![Maven Central](https://img.shields.io/maven-central/v/com.github.hazendaz.tomcat/tomcat9-config)](https://central.sonatype.com/artifact/com.github.hazendaz.tomcat/tomcat9-config)
[![License](https://img.shields.io/github/license/hazendaz/tomcat9-config)](https://www.apache.org/licenses/LICENSE-2.0)
